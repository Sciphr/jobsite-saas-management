...
export async function removeNginxConfig(subdomain) {
  try {
    ...
    // Look for the comment pattern: # subdomain - Auto-generated by SaaS deployment
    const removeConfigScript = `
    sudo awk '
    BEGIN { skip = 0; brace_count = 0 }
    /# ${subdomain} - Auto-generated by SaaS deployment/ { skip = 1; next }
    skip && /server {/ { brace_count = 1; next }
